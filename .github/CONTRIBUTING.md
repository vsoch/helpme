...
When contributing to the HelpMe command line tool, it is 
...
1. Follow the existing code style precedent. This does not need to be strictly
   ...
   standards.
2. Test your PR locally, and provide the steps necessary to test for the
   reviewers.
3. The project's default copyright and header have been included in any new
   source files.
4. All (major) changes to HelpMe must be documented in
...
6. The pull request will be reviewed by others, and the final merge must be
   done by the HelpMe project lead, @vsoch (or approved by her).
...
reported by contacting the project leader. All
